...
_lr_productions = [
  ...
  ('factor -> factor DOT ID OPAR arg_list CPAR','factor',6,'p_factor_call','parser.py',211),
  ('factor -> ID OPAR arg_list CPAR','factor',4,'p_factor_call','parser.py',212),
  ('factor -> factor ARROBA ID DOT ID OPAR arg_list CPAR','factor',8,'p_factor_call','parser.py',213),
  ('atom -> NUMBER','atom',1,'p_atom_num','parser.py',222),
  ('atom -> true','atom',1,'p_atom_boolean','parser.py',226),
  ('atom -> false','atom',1,'p_atom_boolean','parser.py',227),
  ('atom -> ID','atom',1,'p_atom_id','parser.py',231),
  ('atom -> new TYPE','atom',2,'p_atom_instantiate','parser.py',235),
  ('atom -> STRING','atom',1,'p_atom_string','parser.py',239),
  ('arg_list -> expr','arg_list',1,'p_arg_list','parser.py',243),
  ('arg_list -> expr COMMA arg_list','arg_list',3,'p_arg_list','parser.py',244),
  ('arg_list -> empty','arg_list',1,'p_arg_list','parser.py',245),
]
